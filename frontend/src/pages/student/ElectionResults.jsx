      ...
      datasets: [
        {
          ...
          backgroundColor: results.map((r) =>
            r.candidate_id === winnerId ? 'rgba(34, 197, 94, 0.6)' : 'rgba(79, 70, 229, 0.6)',
          ),
          borderColor: results.map((r) =>
            r.candidate_id === winnerId ? 'rgba(34, 197, 94, 1)' : 'rgba(79, 70, 229, 1)',
          ),
          borderWidth: 1,
        },
      ],
            ...
            {(elections || [])
              ...
              .map((e) => (
                <option key={e.election_id} value={e.election_id}>
                  {e.title || `Election #${e.election_id}`} — Voting ended{' '}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div
                          className={`font-bold text-xl ${isWinner ? 'text-green-700' : 'text-indigo-700'}`}
                        >
                          {r.votes}
                        </div>
